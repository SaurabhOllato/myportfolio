...
const About = () => {
  ...
  return (
    <>
      ...
      <section
        ref={ref}
        className="min-h-screen flex items-center justify-center bg-[#111111] text-[#737373] overflow-hidden relative"
      >
        <motion.div
      ...
      <section
        ref={timelineRef}
        className="min-h-screen bg-[#111111] text-[#a0a0a0]  px-4 relative overflow-hidden"
      >
        <motion.div
          className="absolute inset-0 bg-[#111111]"
          style={{
