...
export default function Contact() {
  ...
  return (
    <section className="relative overflow-hidden border-y border-[#333] bg-[#111] text-white py-20 px-4 flex flex-col">
      {/* Top Infinite Scroller */}
      <div className="relative h-24 overflow-hidden">
        <motion.div
          className="absolute whitespace-nowrap top-0 left-0 text-6xl sm:text-7xl md:text-8xl font-bold text-[#555] select-none"
          animate={topControls}
          onHoverStart={() => handleHoverStart(topControls)}
          onHoverEnd={() => handleHoverEnd(topControls, "top")}
      ...
      {/* Main Content */}
      <div className="relative z-10 flex flex-col items-center justify-center mt-20 space-y-10">
        <h2 className="text-xl sm:text-2xl text-center">
          oluwadareseyii@gmail.com
        </h2>
